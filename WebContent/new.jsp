...
<body>
	...
	<form action="NewNetworkServlet" id="newNetwork" method="POST" enctype="multipart/form-data">
		...
		Please upload your network data in CSV formatted txt file. Each line should contain a single binary interaction (ie: HGNC ID of Protein A,HGNC ID of Protein B) where HGNC ID of Protein A < HGNC ID of Protein B.<br>
